...
```
src/anti_pattern_1_blind_trust.py의 deepMerge 함수를 확인해주세요.
잘 동작하나요?
```
...
```
src/anti_pattern_1_blind_trust.py의 deepMerge 함수에
...
`src/test_anti_patterns.py`의 "Blind Trust" 테스트를 실행하세요:
...
`src/anti_pattern_2_no_verification.py`를 확인하세요.
